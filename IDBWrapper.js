...
* @copyright: Copyright (c) 2017 Dima Bresky. All rights reserved.
...
!function (window) {
    ...
    if (typeof window.IDBWrapper === 'function') {
    ...
    * @constructor
    */
    window.IDBWrapper = function (DBNAME, DBVERSION, onUpgradeNeeded) {
     ...
     * @return {Promise}
     */
    window.IDBWrapper.prototype.deleteDatabase = function (name) {
